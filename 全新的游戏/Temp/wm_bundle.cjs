...
var WaterMaterial_exports = {};
__export(WaterMaterial_exports, {
  WaterMaterial: () => WaterMaterial,
  createWaterMesh: () => createWaterMesh,
  sharedWaterMaterial: () => sharedWaterMaterial
});
module.exports = __toCommonJS(WaterMaterial_exports);
...
var WATER_FRAG = (
  ...
  void main() {
    ...
    if (isFall > 0.5) {
      ...
      float Vis = smithGGXCorrelated(NoV, NoL, alpha);
