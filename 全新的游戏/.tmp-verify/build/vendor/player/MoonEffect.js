...
class MoonEffect {
    ...
    update(dt) {
        ...
        (0, renderer_1.renderFrameData)(data, this._vatTime, this._vatFps, transform, renderer, this.scene, this.camera);
