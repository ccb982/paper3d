...
exports.normalizeInjectionSource = normalizeInjectionSource;
exports.parsePhysicsConfig = parsePhysicsConfig;
exports.buildFullConfig = buildFullConfig;
...
/** 规范化单个注入源，补全缺省字段。 */
function normalizeInjectionSource(s) {
    ...
    return {
        ...
        wave: s.wave
            ...
            : undefined,
        waypoints: Array.isArray(s.waypoints) ? s.waypoints.map((w) => ({ x: Number(w.x), y: Number(w.y) })) : undefined,
...
function parsePhysicsConfig(raw, fallbackRes) {
...
function buildFullConfig(raw, fallbackRes) {
    const parsed = parsePhysicsConfig(raw, fallbackRes);
    return {
        ...FluidSolver_1.defaultFluidConfig,
        ...parsed,
        resolution: { ...parsed.resolution },
        scalarConfig: { ...FluidSolver_1.defaultFluidConfig.scalarConfig, ...parsed.scalarConfig },
        levelSetConfig: { ...FluidSolver_1.defaultFluidConfig.levelSetConfig, ...parsed.levelSetConfig },
    };
}
