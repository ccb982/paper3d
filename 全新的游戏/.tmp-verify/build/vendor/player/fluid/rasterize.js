...
exports.rasterizeBoundaryToObstacle = rasterizeBoundaryToObstacle;
exports.buildObstacleTextureFromBitmask = buildObstacleTextureFromBitmask;
...
function rasterizeBoundaryToObstacle(boundary, width, height) {
 ...
 */
function buildObstacleTextureFromBitmask(width, height, data, targetW, targetH) {
