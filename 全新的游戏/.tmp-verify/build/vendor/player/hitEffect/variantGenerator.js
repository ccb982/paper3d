...
exports.shapeSeed = shapeSeed;
exports.generateVariant = generateVariant;
exports.tickVariant = tickVariant;
exports.variantDuration = variantDuration;
// ============ 确定性随机（种子 → 随机序列） ============
...
function shapeSeed(globalSeed, shapeId) {
...
function radialDistort(pts, centroid, amplitude, frequency, phase) {
    return pts.map(p => {
...
function generateVariant(def, seed) {
...
function tickVariant(variant, time, def) {
