...
exports.setGameRenderer = setGameRenderer;
exports.getGameRenderer = getGameRenderer;
exports.shaderDebugEnabled = shaderDebugEnabled;
exports.applyShaderDebug = applyShaderDebug;
let renderer = null;
/** main.ts 创建主渲染器后注入（幂等；之后 UI 侧复用） */
function setGameRenderer(r) {
    renderer = r;
}
