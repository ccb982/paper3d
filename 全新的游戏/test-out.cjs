...
// test-rapier-main.ts
var world = new rapier_default.World({ x: 0, y: 0, z: 0 });
var gb = world.createRigidBody(rapier_default.RigidBodyDesc.fixed().setTranslation(32, -0.06, 32));
world.createCollider(rapier_default.ColliderDesc.cuboid(32, 0.05, 32), gb);
var pb = world.createRigidBody(rapier_default.RigidBodyDesc.dynamic().setTranslation(32, 1.05, 32));
world.createCollider(rapier_default.ColliderDesc.capsule(0.7, 0.35), pb);
var probe = (label, x) => {
  const c = world.intersectionWithShape({ x, y: 1.05, z: 32 }, new rapier_default.Quaternion(0, 0, 0, 1), new rapier_default.Capsule(0.7, 0.35), void 0, void 0, void 0, pb);
