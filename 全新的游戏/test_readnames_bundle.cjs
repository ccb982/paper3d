...
function decodeMultiFrame(buffer) {
  ...
  let offset = 0;
  const magic2 = view.getUint32(offset, false);
  offset += 4;
  if (magic2 !== 1179932723) throw new Error("\u65E0\u6548\u7684 FTX3 \u683C\u5F0F (Magic \u4E0D\u5339\u914D)");
...
// src/vendor/player/core/frameResolver.ts
var frameResolver_exports = {};
__export(frameResolver_exports, {
  FrameResolver: () => FrameResolver
});
var FrameResolver;
var init_frameResolver = __esm({
  "src/vendor/player/core/frameResolver.ts"() {
    "use strict";
    FrameResolver = class {
...
// test_readnames_entry.ts
var fs = require("fs");
var zlib = require("zlib");
var path = require("path");
var { decodeMultiFrame: decodeMultiFrame2 } = (init_ftx(), __toCommonJS(ftx_exports));
var { FrameResolver: FrameResolver2 } = (init_frameResolver(), __toCommonJS(frameResolver_exports));
...
var magic = bin.readUInt32BE(0).toString(16);
...
var resolver = new FrameResolver2(decoded.frames.map((f) => f.name));
console.log("\n=== \u5E27\u540D\u6E05\u5355 ===");
